...
--filter-tcp=443 --ipset="ipset-discord-cloudflare.txt" --hostlist="list-general.txt" --hostlist-exclude="excluded-list-general.txt" --hostlist-auto-fail-threshold=1 --hostlist-auto-fail-time=4 --hostlist-auto="list-general.txt" --dpi-desync=split2 --dpi-desync-split-seqovl=652 --dpi-desync-split-pos=2 --dpi-desync-split-seqovl-pattern="%BIN%tls_clienthello_www_google_com.bin" --new ^
