...
--filter-udp=50000-50100 --ipset="ipset-discord-cloudflare.txt" --dpi-desync=fake --dpi-desync-any-protocol --dpi-desync-cutoff=d3 --dpi-desync-repeats=6 --new ^
--filter-tcp=80 --hostlist="list-general.txt" --dpi-desync=fake,split2 --dpi-desync-autottl=4 --dpi-desync-fooling=md5sig --new ^
